...
| 2 | [`ARCHITECTURE.md`](ARCHITECTURE.md) | **Arsitektur 1 halaman:** diagram, tech stack, hosting (Railway + Vercel, tanpa VPS), 5 alur utama | semua |
| 3 | [`PRD.md`](PRD.md) | Produk: masalah, requirement (P0/P1), arsitektur, API, naskah video ≤ 3 menit, risiko | semua |
| 4 | [`DESIGN.md`](DESIGN.md) | Desain: token warna, font, komponen, wireframe tiap layar, peta integrasi Orca | Lane C, juga A/B untuk UI |
