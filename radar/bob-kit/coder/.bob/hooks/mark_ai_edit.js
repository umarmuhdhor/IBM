...
function linesChanged(tool, input) {
  if (tool === "write_file") {
    if (typeof input.line_count === "number") return input.line_count;
    return typeof input.content === "string" ? countLines(input.content) : void 0;
  }
  if (tool === "insert_content") return typeof input.content === "string" ? countLines(input.content) : void 0;
