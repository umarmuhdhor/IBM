...
1. LANGKAH MANUAL: verifikasi Bob Shell P1 di terminal app dengan Node 24, tanpa agent login/mengetik token (rincian di bawah). Mock server fase 02 belum tersedia di checkout ini.
