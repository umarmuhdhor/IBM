...
export type RadarApi = {
  ...
  runChecks: (workspacePath: string | null) => Promise<RadarChecks>
  getSharePrompts: (workspacePath: string) => Promise<boolean>
  setSharePrompts: (workspacePath: string, enabled: boolean) => Promise<boolean>
...
export const radarApi: RadarApi = {
  ...
  runChecks: (workspacePath) => ipcRenderer.invoke('radar:checks', workspacePath),
  getSharePrompts: (workspacePath) => ipcRenderer.invoke('radar:get-share-prompts', workspacePath),
  setSharePrompts: (workspacePath, enabled) =>
    ipcRenderer.invoke('radar:set-share-prompts', { workspacePath, enabled }),
