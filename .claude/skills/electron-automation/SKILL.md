...
<!-- Source: github.com/fcakyon/claude-codex-settings (plugins/agent-browser/skills/electron), Apache-2.0. Vendored unmodified except `name`. Requires `npx agent-browser`. -->
